          ...
          function fixFolderActionButtons() {
            try {
              if (!document.getElementById('rb-folder-actions-fix')) {
                ...
                style.textContent = [
                  'div.grid.grid-cols-2.gap-1\\.5.mb-5 > div,',
                  ...
                  'div.grid.grid-cols-2.gap-1\\.5.mb-5 > div > button,',
                  ...
                  '  background: linear-gradient(to bottom right, rgb(239 246 255), rgb(250 245 255)) !important;',
                  '  border: 1px solid rgb(191 219 254) !important;',
                  '  box-shadow: 0 1px 3px 0 rgba(147, 51, 234, 0.08) !important;',
                  '  font-size: 0.875rem !important;',
                  '  font-weight: 600 !important;',
                  '  outline: none !important;',
                  '}',
                  'div.grid.grid-cols-2.gap-1\\.5.mb-5 > button:not([data-rb-folder-action="organize"]),',
                  'div.grid.grid-cols-2.gap-1\\.5.mb-5 > div > button:not([data-rb-folder-action="organize"]),',
                  ...
                  'div.grid.grid-cols-2.gap-2.mb-5 > div > button:not([data-rb-folder-action="organize"]),',
                  ...
                  'div.grid.grid-cols-2.gap-2.mb-5 button.text-purple-600,',
                  'div.grid.grid-cols-2.gap-2.mb-5 button.text-purple-700 {',
                  '  background: linear-gradient(to bottom right, rgb(239 246 255), rgb(250 245 255)) !important;',
