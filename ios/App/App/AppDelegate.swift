            ...
            try {
              if (!document.getElementById('rb-folder-actions-fix')) {
                ...
                style.textContent = [
                  ...
                  '}',
                  'div.grid.grid-cols-2.gap-2.mb-5 [data-rb-folder-action="organize"] {',
                  '  box-sizing: border-box !important;',
                  '  width: 100% !important;',
                  '  height: auto !important;',
                  '  min-height: 5.5rem !important;',
                  ...
                  '}',
                  'div.grid.grid-cols-2.gap-2.mb-5 [data-rb-folder-action="organize"] span {',
                  '  background: linear-gradient(to right, #60a5fa, #a855f7) !important;',
                  '  -webkit-background-clip: text !important;',
                  '  background-clip: text !important;',
                  '  color: transparent !important;',
                  '}',
                  'div.grid.grid-cols-2.gap-2.mb-5 [data-rb-folder-action="organize"] svg {',
                  '  stroke: url(#rb-brand-gradient) !important;',
                  '}',
                  'div.grid.grid-cols-2.gap-2.mb-5 > div {',
