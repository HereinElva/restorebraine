...
echo "  bash scripts/mac-capacitor-web-sync.sh"
echo ""
echo "App Store / TestFlight (hosted — login works like Omega):"
echo "  bash scripts/mac-start-fresh.sh"
echo ""
echo "Full wipe + rebuild before Xcode (old huge-replacement behavior):"
echo "  bash scripts/mac-xcode-full-replace.sh"
