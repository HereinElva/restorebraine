...
echo ""
echo "Section 8 must show:"
echo "  Stripe intercept return: OK"
echo "  hosted-runtime-guard overlay: OK"
echo "  RuntimeDiagnostic in live bundle: yes"
echo ""
echo "Mac Capacitor shell is already ready — Xcode Run only:"
