...
const PARTS = [
  { label: 'PART 1 — Boot + auth (paste first)', files: FILES.slice(0, 11) },
  { label: 'PART 2 — Native OAuth + session', files: FILES.slice(11, 18) },
  { label: 'PART 3 — Gallery UI + Layout + CSS (paste last, then Publish)', files: FILES.slice(18) },
];
