...
echo "     In Xcode: View → Navigators → Reports (Cmd+9) → latest build"
echo "     Expand: Restorebraine Copy Public Bundle"
echo "     Log MUST show:"
echo "       Restorebraine DEPLOY OK"
echo "       entry: index-....js"
echo "     (If missing, run bash build-iphone.sh --no-git first — public/ was not built)"
