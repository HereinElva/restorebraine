...
echo ""
echo "Verify: Private Safari tab → https://restorebraine.base44.app"
echo "  • Restorebraine login card — Google / Apple / email"
echo "  • Folders tab + Back to Gallery work"
echo ""
echo "Then iOS (hosted Omega — full replace):"
echo "  bash scripts/mac-start-fresh.sh"
echo "  open ios/App/App.xcworkspace → Clean → Run → Archive"
